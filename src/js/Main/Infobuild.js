...
export function appInit () {
  ...
  application.push(new Application('encryption', 4, 0, '...Who will know?', 'encryption.png', 0, 0, function (app) { encryption.loop(app) }, function (app) { return encryption.setup(app) }, function (app) { encryption.kill(app) }, function (element, app) { encryption.focus(element, app) }, function (app) { encryption.focus(app) }))
  return application
}
