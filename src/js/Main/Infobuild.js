...
export function appInit () {
  ...
  application.push(new Application('Memory', 2, 0, 'memmory Game', 'Memmory.png', 0, 0, function (app) { Memmory.loop() }, function (app) { return Memmory.setup(app) }, function (app) { Memmory.kill(app) }, function (element, app) { Memmory.focus(element, app) }, function (app) { Memmory.focus(app) }))
